			...
			<div class="row d-flex no-gutters">
				<div class="col-md-6 col-lg-5 d-flex">
					<div class="img-about img d-flex align-items-stretch">
						<div class="overlay"></div>
						<div class="img d-flex align-self-stretch align-items-center" style="background-image:url(admin/uploads/<?php echo isset($rowprofile['photo']) ? $rowprofile['photo'] : '' ?>)">
						</div>
					</div>
				</div>
					...
					<div class="py-md-5">
						<div class="row justify-content-start pb-3">
							<div class="col-md-12 heading-section ftco-animate">
								<span class="subheading">Kenalin,</span>
								<h2 class="mb-4" style="font-size: 34px; text-transform: capitalize;"><?php echo isset($rowprofile['profile_name']) ? $rowprofile['profile_name'] : '' ?></h2>
